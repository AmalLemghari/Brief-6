                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                            <tr>
                                <td class="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                    <div class="inline-flex items-center gap-x-3">
                                        ...
                                        <div class="flex items-center gap-x-2">
                                            <img class="object-cover w-10 h-10 rounded-full" src="images/team1.jpg" alt="">
                                            <div>
                                                <h2 class="font-medium text-gray-800 dark:text-white ">Jese Leos</h2>
                                                <p class="text-sm font-normal text-gray-600 dark:text-gray-400">@jeseleos</p>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">jeseleos@example.com</td>
